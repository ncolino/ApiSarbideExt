...
class Database:
    ...
    def ConsultaExtMediaFullByAssetId(self,_id):        
        self.cur.execute("""SELECT distinct EXT_MEDIA.ID_EXT_MEDIA,EXT_MEDIA.ID,EXT_MEDIA.ASSET_ID,DATE_FORMAT(EXT_MEDIA.ASSET_VALUE, '%%Y-%%m-%%d %%H:%%i:%%s') AS ASSET_VALUE,EXT_MEDIA.FORMATO1_ID,EXT_MEDIA.FORMATO2_ID,EXT_MEDIA.CONTENIDO1_ID,EXT_MEDIA.CONTENIDO2_ID
			...
			FROM externalweb.EXT_MEDIA
			LEFT JOIN externalweb.EXT_MEDIA_TYPE ON EXT_MEDIA_TYPE.ID_EXT_MEDIA_TYPE = EXT_MEDIA.ID_EXT_MEDIA_TYPE   
            LEFT JOIN (
                   SELECT EXT_QUALITY.ID_EXT_MEDIA,EXT_QUALITY.FRAME_WIDTH,EXT_QUALITY.FRAME_HEIGHT,PUB_CONFIG.VOD_URL,
					...
					FROM externalweb.EXT_MEDIA,externalweb.EXT_QUALITY, externalweb.EXT_SUPPORT, externalweb.EXT_SERVER, externalweb.PUB_CONFIG
            ...
            LEFT JOIN (
				 ...
				 from  externalweb.EXT_MEDIA, externalweb.CMS_RENDITION, externalweb.EXT_QUALITY_CMS_RENDITION              
            ...
            LEFT JOIN (
				...
				FROM externalweb.EXT_MEDIA, externalweb.EXT_SUPPORT,externalweb.EXT_SERVER,externalweb.EXT_IMAGE,externalweb.EXT_IMAGE_TYPE, externalweb.PUB_CONFIG
